...
select * from transferPeriods tp

select * from viewPeriods vp 

update transferPeriods set endDateTime = '2023-02-03 19:00:00'

update viewPeriods set startDateTime = '2023-02-03 19:00:00' where id = 3

select * from againstGames ag  where startDateTime > '2023-02-03' and startDateTime < '2023-02-04'

select * from againstGames ag  where startDateTime > '2023-01-20' and startDateTime < '2023-01-21'
